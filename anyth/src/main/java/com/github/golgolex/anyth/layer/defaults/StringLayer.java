...
@ConvertLayer(object = String.class)
public class StringLayer implements CommonBasedLayer<String, String> {
    @Override
    ...
    @Override
    public String serializeToString(String serialized)
    {
        return serialized;
    }

    @Override
    public String deserializeFromString(String string)
    {
        return string;
    }
}
