...
@ConvertLayer(object = Boolean.class)
public class BooleanLayer implements CommonBasedLayer<Boolean, Boolean> {
    @Override
    ...
    @Override
    public String serializeToString(Boolean serialized)
    {
        return String.valueOf(serialized);
    }

    @Override
    public Boolean deserializeFromString(String string)
    {
