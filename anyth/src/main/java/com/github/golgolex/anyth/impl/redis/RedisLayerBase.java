...
public abstract class RedisLayerBase<TObject> implements LayerBase<TObject, String> {

    @Override
    public TObject deserialize(Object serialized)
    {
        if (!(serialized instanceof String string)) {
            return null;
        }
        return deserialize(string);
    }

    public abstract TObject deserialize(String string);
}
